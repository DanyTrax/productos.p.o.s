...
class Invoices extends CI_Controller
{
    ...
    public function ShowTicket($id)
    {
        ...
        switch ($pmInfo['type']) {
            case 'card':
                ...
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCard") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">xxxx xxxx xxxx ' . $last4 . '</td></tr><tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCardHold") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . $holder . '</td></tr>';
                break;
            case 'cheque':
                $chq = isset($PayMethode[1]) ? $PayMethode[1] : '';
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("ChequeNum") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . $chq . '</td></tr>';
                break;
            default:
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Paid") . ' (' . $methodLabel . ')</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . number_format((float)$sale->firstpayement, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr>';
        }
        ...
        if($payements){
          ...
          foreach ($payements as $pay) {
             ...
             $pInf = Payment_method::parse($pay->paidmethod);
             $pLabel = htmlspecialchars($pInf['display_name'], ENT_QUOTES, 'UTF-8');
             switch ($pInf['type']) {
                case 'card':
                    $last4p = (isset($PayMethode[1]) && strlen((string) $PayMethode[1]) >= 4) ? substr($PayMethode[1], - 4) : '****';
                    $holdp = isset($PayMethode[2]) ? $PayMethode[2] : '';
                    $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCard") . ' (xxxx xxxx xxxx ' . $last4p . ')</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'. number_format((float)$pay->paid, $this->setting->decimals, '.', '') .' ' . $this->setting->currency . '</td></tr><tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCardHold") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . $holdp . '</td></tr>';
                    break;
                case 'cheque':
                    $chqp = isset($PayMethode[1]) ? $PayMethode[1] : '';
                    $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("ChequeNum") . ' (' . $chqp . ')</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'.number_format((float)$pay->paid, $this->setting->decimals, '.', '').' ' . $this->setting->currency . '</td></tr>';
                    break;
                default:
                    $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Paid") . ' (' . $pLabel . ')</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'. number_format((float)$pay->paid, $this->setting->decimals, '.', '') .' ' . $this->setting->currency . '</td></tr>';
           }
          }
       } else{
          $ticket .= '</tbody></table>';
    ...
    public function showInvoice($id)
    {
        ...
        $PayMethode = explode('~', $sale->paidmethod);
        $invPm = Payment_method::parse($sale->paidmethod);
        switch ($invPm['type']) {
            case 'card':
                $last4i = (isset($PayMethode[1]) && strlen((string) $PayMethode[1]) >= 4) ? substr($PayMethode[1], - 4) : '****';
                $holdi = isset($PayMethode[2]) ? $PayMethode[2] : '';
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCard") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">xxxx xxxx xxxx ' . $last4i . '</td></tr><tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCardHold") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . $holdi . '</td></tr></tbody></table></div>';
                break;
            case 'cheque':
                $chqi = isset($PayMethode[1]) ? $PayMethode[1] : '';
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("ChequeNum") . '</td><td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">' . $chqi . '</td></tr></tbody></table></div>';
                break;
            default:
    ...
    public function payaments($id) {
      ...
      <td>'.htmlspecialchars(Payment_method::display_label($sale->paidmethod), ENT_QUOTES, 'UTF-8').'</td>
      <td> </td></tr>';
      $payements = Payement::find('all', array('conditions' => array('sale_id = ?', $id)));
      if($payements){
         foreach ($payements as $pay) {
            ...
            <td>'.htmlspecialchars(Payment_method::display_label($pay->paidmethod), ENT_QUOTES, 'UTF-8').'</td>
