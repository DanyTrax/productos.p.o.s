      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
         <div class="container-fluid">
            <div class="navbar-header">
               ...
               <a class="navbar-brand app-navbar-brand" href="<?= base_url(); ?>" title="<?= htmlspecialchars($this->setting->companyname, ENT_QUOTES, 'UTF-8'); ?>"><span class="app-navbar-logo-circle" aria-hidden="true"><?php if ($this->setting->logo) { ?><img src="<?= base_url() ?>files/Setting/<?= htmlspecialchars($this->setting->logo, ENT_QUOTES, 'UTF-8'); ?>" alt="" class="app-navbar-logo-img"><?php } else { ?><img src="<?= base_url() ?>assets/img/logo.png" alt="" class="app-navbar-logo-img"><?php } ?></span></a>
            </div>
